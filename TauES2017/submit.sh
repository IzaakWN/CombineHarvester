...
COMMON="-t _ZTTregion2_45-7 -c 0.960 0.970 0.980 0.990 1.000 1.010 1.020 1.030 1.040" #_mtlt50_0p10 _ZTTregion2_45-5 _mtlt50 _mtlt50_0p05
...
./submitFitCommand.py $COMMON -B -n -N 1000 -s $SEEDS1 -o m_2 m_vis -d DM0 DM1 DM10
...
# ASIMOV:
#./doFit_TES.sh -B -n -N -1 -t _mtlt50 _mtlt50_0p05 _mtlt50_0p10 _ZTTregion2_45-5 _ZTTregion2_45-7
