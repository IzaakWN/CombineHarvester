Control plots stacked from the shape templates in the inputs to combine. The errorband on the background estimation only includes the statistical uncertainties. For individual shapes, see the <a href="../shapes">here<a>.
...
Plots contain ZTT enriched region with
 ...
 - restricted tau mass m_2:
     <a href="?match=m_2.*DM1(?!0)&regexp=on">DM1</a>:   [ 0.30 - dm, 1.3*sqrt(pt/100) + dm ] -> [ 0.35, 1.2 ]
 ...
 - shape variations for processes <a href="?match=TTT">TTT</a>, <a href="?match=TTT">TTJ</a>, <a href="?match=ZTT">ZTT</a>, <a href="?match=ZJ">ZJ</a>, <a href="?match=ZL">ZL</a>, <a href="?match=STT">STT</a>, <a href="?match=JTF">JTF</a>, <a href="?match=VV">VV</a> include
     <a href="?match=TES"       >TES</a>:         tau energy scale (TES, -6 to +6%)
